...
export function HeroCtaButtons({ ctaWhatsapp, ctaOnline }: HeroCtaButtonsProps) {
  return (
    <div className="mt-5 sm:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4">
      ...
      >
        ...
        >
          ...
          {WA_ICON}
          <span className="relative">{ctaWhatsapp}</span>
        </a>
      </Button>
      <Button
        asChild
