    ...
    <section className="py-16 md:py-24 bg-[oklch(0.16_0.035_240)]">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
        ...
        <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-white text-balance">
          Ainda com dor? Me manda mensagem agora.
        </h2>
        
        <p className="mt-4 text-lg text-white/70 text-pretty max-w-2xl mx-auto">
          Sem compromisso. Só uma conversa para entender seu caso e ver se posso te ajudar.
        </p>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            asChild
            size="lg"
            className="bg-[#25D366] hover:bg-[#20BD5A] text-white text-base font-semibold px-8 h-14 w-full sm:w-auto"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="border-white/30 text-white hover:bg-white/10 text-base h-14 w-full sm:w-auto"
          >
            <a href="#triagem">
        ...
        <p className="mt-6 text-sm text-white/50">
          Respondo hoje · Atendimento presencial e online
        </p>
      </div>
    </section>
  )
