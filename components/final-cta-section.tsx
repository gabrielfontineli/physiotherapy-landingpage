      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            asChild
            size="lg"
            className="btn-glow-green bg-[#25D366] hover:bg-[#20BD5A] text-white text-base font-semibold px-8 h-14 w-full sm:w-auto"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="btn-lift border-white/30 text-white hover:bg-white/10 text-base h-14 w-full sm:w-auto"
          >
            <a href="#triagem">
              {t("ctaOnline")}
